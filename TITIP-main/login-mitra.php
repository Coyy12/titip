    ...
    <script>
      document
        ...
        .addEventListener("submit", function (event) {
          ...
          // Ambil ID pengguna dan kata sandi
          const userId = document.getElementById("user-id").value;
          const password = document.getElementById("password").value;

          // Lakukan validasi sederhana (optional)
          if (userId && password) {
            // Arahkan ke halaman mitra
            window.location.href = "laman-mitra.php";
          } else {
            alert("Silakan masukkan User ID dan Password yang valid.");
          }
        });
    </script>
